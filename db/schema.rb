...
ActiveRecord::Schema.define(version: 20_221_021_004_523) do
  ...
  create_table 'thredded_categories', force: :cascade do |t|
    ...
    t.index %w[messageboard_id slug], name: 'index_thredded_categories_on_messageboard_id_and_slug', unique: true
  ...
  create_table 'thredded_messageboard_notifications_for_followed_topics', force: :cascade do |t|
    ...
    t.index %w[user_id messageboard_id notifier_key],
  ...
  create_table 'thredded_messageboard_users', force: :cascade do |t|
    ...
    t.index %w[thredded_messageboard_id last_seen_at], name: 'index_thredded_messageboard_users_for_recently_active'
    t.index %w[thredded_messageboard_id thredded_user_detail_id], name: 'index_thredded_messageboard_users_primary',
                                                                  unique: true
  end
  ...
  create_table 'thredded_notifications_for_followed_topics', force: :cascade do |t|
    ...
    t.string 'notifier_key', limit: 90, null: false
    t.boolean 'enabled', default: true, null: false
    t.index %w[user_id notifier_key], name: 'thredded_notifications_for_followed_topics_unique', unique: true
  end
  ...
  create_table 'thredded_notifications_for_private_topics', force: :cascade do |t|
    ...
    t.string 'notifier_key', limit: 90, null: false
    t.boolean 'enabled', default: true, null: false
    t.index %w[user_id notifier_key], name: 'thredded_notifications_for_private_topics_unique', unique: true
  end
  ...
  create_table 'thredded_post_moderation_records', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.index %w[messageboard_id created_at], name: 'index_thredded_moderation_records_for_display',
  ...
  create_table 'thredded_posts', force: :cascade do |t|
    ...
    t.index %w[moderation_state updated_at], name: 'index_thredded_posts_for_display'
    t.index %w[postable_id created_at], name: 'index_thredded_posts_on_postable_id_and_created_at'
  ...
  create_table 'thredded_private_posts', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[postable_id created_at], name: 'index_thredded_private_posts_on_postable_id_and_created_at'
  end
  ...
  create_table 'thredded_topics', force: :cascade do |t|
    ...
    t.index %w[moderation_state sticky updated_at], name: 'index_thredded_topics_for_display',
  ...
  create_table 'thredded_user_details', force: :cascade do |t|
    ...
    t.index %w[moderation_state moderation_state_changed_at], name: 'index_thredded_user_details_for_moderations',
  ...
  create_table 'thredded_user_messageboard_preferences', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[user_id messageboard_id], name: 'thredded_user_messageboard_preferences_user_id_messageboard_id',
                                         unique: true
  end
  ...
  create_table 'thredded_user_post_notifications', force: :cascade do |t|
    ...
    t.index %w[user_id post_id], name: 'index_thredded_user_post_notifications_on_user_id_and_post_id', unique: true
  end
  ...
  create_table 'thredded_user_private_topic_read_states', force: :cascade do |t|
    ...
    t.index %w[user_id postable_id], name: 'thredded_user_private_topic_read_states_user_postable', unique: true
  end
  ...
  create_table 'thredded_user_topic_follows', force: :cascade do |t|
    ...
    t.index %w[user_id topic_id], name: 'thredded_user_topic_follows_user_topic', unique: true
  end
  ...
  create_table 'thredded_user_topic_read_states', force: :cascade do |t|
    ...
    t.index %w[user_id messageboard_id], name: 'thredded_user_topic_read_states_user_messageboard'
    t.index %w[user_id postable_id], name: 'thredded_user_topic_read_states_user_postable', unique: true
  end
