...
class NotesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @note.save
        format.html { redirect_to user_note_url(user_id: current_user, id: @note), notice: 'Note was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @note.update(note_params)
        format.html { redirect_to user_note_url(user_id: current_user, id: @note), notice: 'Note was successfully updated.' }
